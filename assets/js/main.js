    ...
    navigationProvider.protoList = {
        ...
        JS: [
            ...
            },
            {
                ...
                date: toTs('1/12/2016 08:00'),
                controller: 'jsDomCreationController',
                template: 'featureSetsB.html'
            },
            {
                title: 'JS-jQuery',
                date: toTs('1/11/2016 08:00'),
